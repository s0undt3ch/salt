...
class DebianIpTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test_get_interface(self):
        ...
        mock_ret = {
            "lo": {
                "enabled": True,
                "data": {"inet": {"addrfam": "inet", "proto": "loopback"}},
            }
        }
        with patch.object(
            debian_ip, "_parse_interfaces", MagicMock(return_value=mock_ret)
        ):
    ...
    def test_build_interface(self):
        ...
        with patch(
            ...
            with patch.object(
                ...
                self.assertRaises(
                    AttributeError, debian_ip.build_interface, "eth0", "bond", "enabled"
                )
        ...
        interfaces = [
            ...
            # Slave iface
            {
                ...
                "iface_type": "slave",
                "enabled": True,
                "settings": {"master": "bond0", "noifupdown": True},
                "return": [
                    "auto eth4\n",
    ...
    def test_get_network_settings(self):
        ...
        with patch.dict(
            ...
            "salt.modules.debian_ip._parse_searchdomain",
